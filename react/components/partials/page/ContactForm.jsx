...
const ContactForm = () => {
    ...
    const handleSubmit=(e)=>{
        ...
        if(name!==""&&mail!==""&&phone!==""&&message!==""&&message.length>=6&&mailError===""){
                ...
                contactApi(name,mail,phone,message,setName,setMail,setPhone,setMessage,setNameError,setMailError,setPhoneError,setMessageError)
        }
        else{
            if(name===""){
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 ">
                    <div className="form-group">
                        <input
                            ...
                            placeholder="Phone *"
                            value={phone}
                            onChange={e=>JSON.stringify(e.target.value).length <13 && setPhone(e.target.value)}
                        />
