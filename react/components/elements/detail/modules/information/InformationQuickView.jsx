...
class InformationQuickView extends Component {
    ...
    render() {
        const { product,wishListStatus } = this.props;
        return (
            <div className="ps-product__info">
                ...
                {product.is_sale === true ? (
                    ...
                    <div>
                            {product&&product.flag===""?<h4 className="ps-product__price">
                                ${product.price}
                            </h4>:<h4 className="ps-product__price">
                                {/* { '$'} */}
                                ${product.price}
                ...
                <div className="ps-product__desc">
                    {/* <p>
                        ...
                        <Link href="/shop">
                            <a>
                                <strong> {"PICCOSOFT"}</strong>
                            </a>
                        </Link>
                    </p> */}
                    {/* <p>Description</p> */}
                    <div className="ps-list--dot" dangerouslySetInnerHTML={{__html: product.description}} />
